...
you can find most of the code I used there minus some changes I made to both [index page](./index.html) and [main go file](./main.go) 
...
me the changes that would be awesome, I am learning as I go and showing my progress along the way
